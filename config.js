...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "Manoj-Ai=dwpFzb5D#1M1iZuorJJy4KDpr6ckP2yDlUMa86puiE3DOlsI0Q3M", // Your session ID
  ...
  // --- Bot Identity ---
  BOT_NAME: process.env.BOT_NAME || "Manoj-Ait", // Bot name shown in menus 
  ...
  // --- General Settings ---
  OWNER_NUMBER: process.env.OWNER_NUMBER || "91700XXXXXXX", // Your WhatsApp number
  PREFIX: process.env.PREFIX || ".", // Command prefix
  ANTI_DEL_PATH: process.env.ANTI_DEL_PATH || "log", // Resend deleted messages to 'log' or 'same'
  AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY Manoj-Ai 🤍*", // Auto-reply text for status
